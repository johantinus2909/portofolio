  ...
  <nav class="side-navbar">
    <div class="side-navbar-wrapper">
      <div class="sidenav-header d-flex align-items-center justify-content-center">
        ...
        <div class="sidenav-header-logo"><a href="master.php" class="brand-small text-center"> <strong>J</strong><strong class="text-primary">S</strong></a></div>
      </div>
      <div class="main-menu">
      ...
      <ul id="side-admin-menu" class="side-menu list-unstyled">
        ...
        <li> <a href="project_add.php"> <i class="icon-screen"> </i>Materi Kuliah</a></li>
        <li> <a href="project_tampil.php"> <i class="icon-screen"> </i>Daftar Materi Kuliah</a></li>
      </ul>
    </div>
  </nav>
  <div class="page">
        ...
        <div class="container-fluid">
          <div class="navbar-holder d-flex align-items-center justify-content-between">
            <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="master.php" class="navbar-brand">
                <div class="brand-text d-none d-md-inline-block"><span></span><strong class="text-primary">Johan Sapumaijat</strong></div>
              </a></div>
