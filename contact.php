				...
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="contact-info">
							...
							<?php } ?>
							<span><i class="fa fa-phone-square"></i>+62823-8410-9792</span>
							<span><i class="fa fa-map-marker"></i>Padang : Institut Teknologi Padang</span>
							<span><i class="fa fa-globe"></i><a href="index.php">Johan</a></span>
						</div>
					</div>
